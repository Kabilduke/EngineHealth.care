...
Machine learning model was trained on a 20,000 columns and 7 rows dataset to predict the health of car engines using various algorithm like KNN, SVM, XBoost Classifer and Random Forest
